...
export ZSH="/Users/youngkyoonim/.oh-my-zsh"
...
__conda_setup="$('/Users/youngkyoonim/.pyenv/versions/anaconda3-2020.11/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
unset __conda_setup
# <<< conda initialize <<<
# conda 명령어 참고 https://medium.com/@5eo1ab/conda-env-터미널-명령어-adc8366f8a9d
